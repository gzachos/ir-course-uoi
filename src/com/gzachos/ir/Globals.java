...
public class Globals {
	public static final String TOKENIZER_NAME = "classic", TOKENFILTER_NAME = "lowercase";
	...
	public static final Map<String, Float> QUERY_BOOSTS = Map.of("title", 10.0f, "content", 1.0f, "multimedia",
			0.5f, "quotes", 1.0f, "references", 0.1f);
	public static final Map<String, Float> DEFAULT_QUERY_BOOSTS = Map.of("title", 10.0f, "content", 1.0f,
			"multimedia", 1.0f, "quotes", 1.0f, "references", 1.0f);
	public static final Map<String, Float> IDENTITY_QUERY_BOOSTS = Map.of("title", 1.0f, "content", 1.0f,
			"multimedia", 1.0f, "quotes", 1.0f, "references", 1.0f);
	...
	public static final Sort SORT_OPTIONS[] = { Sort.RELEVANCE,
			new Sort(new SortField[] {
					new SortField(BY_PUBLICATION_TIME_FIELD_NAME, SortField.Type.LONG, true),
					SortField.FIELD_SCORE }),
			new Sort(new SortField[] {
					new SortField(BY_PUBLICATION_TIME_FIELD_NAME, SortField.Type.LONG, false),
					SortField.FIELD_SCORE }),
			new Sort(new SortField[] { new SortField(BY_UPDATE_TIME_FIELD_NAME, SortField.Type.LONG, true),
					SortField.FIELD_SCORE }),
			new Sort(new SortField[] { new SortField(BY_UPDATE_TIME_FIELD_NAME, SortField.Type.LONG, false),
					SortField.FIELD_SCORE }) };
}
